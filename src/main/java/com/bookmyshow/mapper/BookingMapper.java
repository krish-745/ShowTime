...
public class BookingMapper {
    ...
    private static TheaterDTO mapTheatreToTheatreDTO(Theater theater) {
    ...
    private static MovieDTO mapMovieToMovieDTO(Movie movie) {
        MovieDTO movieDTO = new MovieDTO();
        movieDTO.setMovieId(movie.getMovie_id());
